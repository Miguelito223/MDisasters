function convars()
    CreateConVar( "MDisasters_tornado_enable_configuration", "0", {FCVAR_ARCHIVE}, "" )
    ...
    CreateConVar( "MDisasters_earthquake_enable_configuration", "0", {FCVAR_ARCHIVE}, "" )
    ...
    CreateConVar( "MDisasters_volcano_enable_configuration", "0", {FCVAR_ARCHIVE}, "" )
    CreateConVar( "MDisasters_volcano_time", "200", {FCVAR_ARCHIVE}, "" )

    CreateConVar( "MDisasters_tsunami_enable_configuration", "0", {FCVAR_ARCHIVE}, "" )
